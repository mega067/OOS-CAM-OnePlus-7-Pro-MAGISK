...
.method public obtain(J)Lcom/oneplus/util/BufferPool$BufferHolder;
    ...
    const-string p2, "), use buffer with exact size index. "
    ...
    const-string p2, "), use buffer with greater size index: "
    ...
    const-string v3, "] No enough space to create buffer with "
    ...
    const-string v10, ") for obtaining "
    ...
    const-string p2, "), create new buffer. "
    ...
    const-string v3, "] Failed to create new buffer with "
    ...
    const-string v7, "] Failed to create new buffer with "
