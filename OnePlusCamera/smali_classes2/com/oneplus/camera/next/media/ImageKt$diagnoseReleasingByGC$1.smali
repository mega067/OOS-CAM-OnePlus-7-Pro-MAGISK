...
.method public final invoke(Lcom/oneplus/diagnostics/DiagnosticContext;)V
    ...
    .line 564
    iget-object p0, p0, Lcom/oneplus/camera/next/media/ImageKt$diagnoseReleasingByGC$1;->$this_diagnoseReleasingByGC:Lcom/oneplus/camera/next/media/Image;

    invoke-interface {p0}, Lcom/oneplus/camera/next/media/Image;->getCreationStackTrace()Ljava/util/List;
    ...
    const-string v0, "Instance creation stack trace:"
    ...
    .line 568
    invoke-virtual {p1, p0}, Lcom/oneplus/diagnostics/DiagnosticContext;->describe([Ljava/lang/StackTraceElement;)V
    ...
    :cond_1
    :goto_0
    const-string p0, "Please make sure instance will be released explicitly."
