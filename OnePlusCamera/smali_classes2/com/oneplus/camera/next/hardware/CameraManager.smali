...
.field private static final PROP_ERROR_GET_CAMERAIDS_LIST:Lcom/oneplus/base/PropertyKey;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/oneplus/base/PropertyKey<",
            "Ljava/lang/Boolean;",
...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/oneplus/camera/next/hardware/CameraManager$Companion;

    const/4 v2, 0x0

    invoke-direct {v1, v2}, Lcom/oneplus/camera/next/hardware/CameraManager$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v1, Lcom/oneplus/camera/next/hardware/CameraManager;->Companion:Lcom/oneplus/camera/next/hardware/CameraManager$Companion;
    ...
    sput-object v1, Lcom/oneplus/camera/next/hardware/CameraManager;->PROP_CAMERAS:Lcom/oneplus/base/PropertyKey;
    ...
    const-string v4, "ErrorGetCameraIdsList"

    invoke-direct {v1, v4, v2, v0, v3}, Lcom/oneplus/base/PropertyKey;-><init>(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/Object;)V

    sput-object v1, Lcom/oneplus/camera/next/hardware/CameraManager;->PROP_ERROR_GET_CAMERAIDS_LIST:Lcom/oneplus/base/PropertyKey;
...
.method public static final synthetic access$getCameraManager$p(Lcom/oneplus/camera/next/hardware/CameraManager;)Landroid/hardware/camera2/CameraManager;
    .locals 0

    .line 24
    iget-object p0, p0, Lcom/oneplus/camera/next/hardware/CameraManager;->cameraManager:Landroid/hardware/camera2/CameraManager;
...
.method public static final synthetic access$getPROP_ERROR_GET_CAMERAIDS_LIST$cp()Lcom/oneplus/base/PropertyKey;
    .locals 1

    .line 24
    sget-object v0, Lcom/oneplus/camera/next/hardware/CameraManager;->PROP_ERROR_GET_CAMERAIDS_LIST:Lcom/oneplus/base/PropertyKey;
...
.method public static final synthetic access$setCameraManager$p(Lcom/oneplus/camera/next/hardware/CameraManager;Landroid/hardware/camera2/CameraManager;)V
    .locals 0

    .line 24
    iput-object p1, p0, Lcom/oneplus/camera/next/hardware/CameraManager;->cameraManager:Landroid/hardware/camera2/CameraManager;

    return-void
.end method

.method public static final synthetic access$setReadOnly(Lcom/oneplus/camera/next/hardware/CameraManager;Lcom/oneplus/base/PropertyKey;Ljava/lang/Object;)Z
    .locals 0
...
.method private final onCameraInfoUpdated(Ljava/util/List;I)V
    ...
    const-string v9, " in not contained in new list"
    ...
    const-string v8, " is not closed yet, release later"
...
.method private final onTimeoutUpdatingCameraInfoList()V
    ...
    .line 403
    invoke-virtual {p0}, Lcom/oneplus/camera/next/hardware/CameraManager;->getDispatcher()Lcom/oneplus/threading/Dispatcher;

    move-result-object v0

    new-instance v1, Lcom/oneplus/camera/next/hardware/CameraManager$onTimeoutUpdatingCameraInfoList$1;

    invoke-direct {v1, p0}, Lcom/oneplus/camera/next/hardware/CameraManager$onTimeoutUpdatingCameraInfoList$1;-><init>(Lcom/oneplus/camera/next/hardware/CameraManager;)V
...
.method private final updateCameraInfoList()V
    ...
    const-string v1, "updateCameraInfoList() - No camera manager"
    ...
    const-string v5, "updateCameraInfoList() - System list count["
    ...
    invoke-virtual {v2, v9, v10}, Lcom/oneplus/threading/UniqueDispatcherOperation;->schedule(J)Z
    ...
    const-string v4, "updateCameraInfoList() - System list count["
    ...
    const-string v3, "updateCameraInfoList() - Create camera info list"
    ...
    const-string v5, "updateCameraInfoList() - Camera ID list : "
    ...
    const-string v4, "updateCameraInfoList() - Failed to get camera ID list"
    ...
    const-string v9, "updateCameraInfoList() - Error occurred before, skip creating camera info for "
    ...
    const-string v10, "updateCameraInfoList() - Get characteristics for camera "
    ...
    invoke-static {v2, v9}, Lcom/oneplus/base/Log;->v(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 561
    iget-object v13, v1, Lcom/oneplus/camera/next/hardware/CameraManager;->cameraBuilders:Ljava/util/ArrayList;
    ...
    check-cast v16, Lcom/oneplus/camera/next/hardware/CameraBuilder;

    .line 565
    :try_start_2
    iget-object v2, v1, Lcom/oneplus/camera/next/hardware/CameraManager;->context:Landroid/content/Context;
    :try_end_2
    ...
    const-string v4, "updateCameraInfoList() - Failed to create camera info for "
    ...
    const-string v6, "updateCameraInfoList() - Camera info created for "
    ...
    const-string v5, "updateCameraInfoList() - No camera info created for "
    ...
    const-string v3, "updateCameraInfoList() - Failed to get characteristics for camera "
    ...
    const-string v2, "updateCameraInfoList() - No camera info created"
    ...
    const-string v3, "updateCameraInfoList() - Empty camera ID list"
    ...
    .line 593
    iget-object v0, v1, Lcom/oneplus/camera/next/hardware/CameraManager;->updateCameraInfoListOperation:Lcom/oneplus/threading/UniqueDispatcherOperation;
    ...
    const-string v1, "updateCameraInfoList() - Failed to create camera info list"
    ...
    const-string v3, "updateCameraInfoList() - Simulate slow updating"
    ...
    const-string v4, "updateCameraInfoList() - "
    ...
    invoke-direct {v3, v1, v0, v15}, Lcom/oneplus/camera/next/hardware/CameraManager$CameraInfoUpdatedCallback;-><init>(Lcom/oneplus/camera/next/hardware/CameraManager;Ljava/util/List;I)V
    ...
    const-string v6, "updateCameraInfoList() - "
    ...
    const-string v6, "updateCameraInfoList() -   Lens count: "
    ...
    const-string v6, "updateCameraInfoList() -   Lens facing: "
    ...
    const-string v6, "updateCameraInfoList() -   Lens type: "
    ...
    const-string v6, "updateCameraInfoList() -   Role: "
    ...
    const-string v6, "updateCameraInfoList() -   Sensor size: "
    ...
    const-string v6, "updateCameraInfoList() -   Special mode only: "
    ...
    const-string v4, "updateCameraInfoList() - No camera created in "
...
.method protected onDeinitialize()V
    ...
    const-string v3, " is not closed yet, release later"
...
.method public final updateCameras()V
    ...
    const-string v2, "updateCameras() - Camera info list file is "
    ...
    const-string v0, "updateCameras() - Permission is not granted yet"
