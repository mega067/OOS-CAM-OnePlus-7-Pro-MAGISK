...
.method private decodeGifAsync()V
    ...
    const-string v6, "decodeGifAsync() - sleep time: "
...
.method private loadFile()Z
    ...
    invoke-virtual {v4, v5}, Lcom/oneplus/util/GifDecoder;->read(Ljava/lang/String;)V
    ...
    .line 437
    :cond_2
    instance-of v4, v5, Landroid/net/Uri;
    ...
    .line 450
    invoke-virtual {v5, v9, v3, v10}, Ljava/io/ByteArrayOutputStream;->write([BII)V
    ...
    invoke-virtual {v4, v6}, Lcom/oneplus/util/GifDecoder;->read([B)V
...
.method public start()V
    ...
    .line 560
    sget-object p0, Lcom/oneplus/drawable/MovieDrawable;->m_BackgroundExecutor:Ljava/util/concurrent/Executor;
