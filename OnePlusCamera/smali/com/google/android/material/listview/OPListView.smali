...
.method private init(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 87
    invoke-virtual {p0, p3}, Lcom/google/android/material/listview/OPListView;->setBackground(Landroid/graphics/drawable/Drawable;)V

    .line 90
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/material/listview/OPListView;->getResources()Landroid/content/res/Resources;
    ...
    .line 91
    invoke-virtual {p0, v0}, Lcom/google/android/material/listview/OPListView;->setOverScrollMode(I)V
    ...
    invoke-virtual {p0, p2}, Lcom/google/android/material/listview/OPListView;->setDividerHeight(I)V
...
.method private setDelViewLocation()V
    ...
    .line 602
    invoke-virtual {p0}, Lcom/google/android/material/listview/OPListView;->getFirstVisiblePosition()I

    move-result v0

    .line 604
    invoke-virtual {p0}, Lcom/google/android/material/listview/OPListView;->getChildCount()I

    move-result v1

    .line 606
    invoke-virtual {p0}, Lcom/google/android/material/listview/OPListView;->getLastVisiblePosition()I

    move-result v2

    invoke-virtual {p0}, Lcom/google/android/material/listview/OPListView;->getAdapter()Landroid/widget/ListAdapter;
    ...
    .line 613
    :goto_1
    invoke-virtual {p0}, Lcom/google/android/material/listview/OPListView;->getTop()I

    .line 614
    invoke-virtual {p0}, Lcom/google/android/material/listview/OPListView;->getBottom()I
    ...
    .line 627
    invoke-virtual {p0, v7}, Lcom/google/android/material/listview/OPListView;->getChildAt(I)Landroid/view/View;
...
.method private startDelGoneAnimation()V
    ...
    .line 497
    iget-object v0, p0, Lcom/google/android/material/listview/OPListView;->mDeleteAnimationListener:Lcom/google/android/material/listview/OPListView$DeleteAnimationListener;

    if-eqz v0, :cond_0

    .line 498
    invoke-interface {v0}, Lcom/google/android/material/listview/OPListView$DeleteAnimationListener;->onAnimationUpdate()V

    .line 500
    :cond_0
    iput-boolean v2, p0, Lcom/google/android/material/listview/OPListView;->mDisableTouchEvent:Z
    ...
    iput-object v3, p0, Lcom/google/android/material/listview/OPListView;->mDelAniSet:Landroid/animation/AnimatorSet;
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    .line 119
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getOverscrollHeader()Landroid/graphics/drawable/Drawable;

    move-result-object v2

    .line 120
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getOverscrollFooter()Landroid/graphics/drawable/Drawable;
    ...
    .line 128
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getPaddingLeft()I
    ...
    .line 129
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getRight()I

    move-result v8

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getLeft()I

    move-result v9

    sub-int/2addr v8, v9

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getPaddingRight()I
    ...
    .line 131
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getChildCount()I

    move-result v8

    .line 132
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getHeaderViewsCount()I

    move-result v9

    .line 133
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getCount()I

    move-result v10

    .line 134
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getFooterViewsCount()I
    ...
    .line 137
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getFirstVisiblePosition()I

    move-result v13

    .line 138
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getAdapter()Landroid/widget/ListAdapter;
    ...
    .line 147
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getListPaddingTop()I

    move-result v14

    .line 148
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getListPaddingBottom()I
    ...
    .line 151
    :goto_3
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getBottom()I

    move-result v16

    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getTop()I
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->getScrollY()I
    ...
    .line 152
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/material/listview/OPListView;->isStackFromBottom()Z
    ...
    .line 170
    :cond_a
    invoke-virtual {v0, v2}, Lcom/google/android/material/listview/OPListView;->getChildAt(I)Landroid/view/View;
    ...
    .line 201
    :cond_14
    invoke-virtual {v0, v4}, Lcom/google/android/material/listview/OPListView;->getChildAt(I)Landroid/view/View;
...
.method drawDivider(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)V
    ...
    .line 287
    invoke-virtual {p0}, Lcom/google/android/material/listview/OPListView;->getWidth()I
...
.method public setDelPositionsList(Ljava/util/ArrayList;)V
    ...
    .line 381
    iget-boolean v1, p0, Lcom/google/android/material/listview/OPListView;->mAnimRunning:Z
    ...
    .line 382
    iput-boolean v0, p0, Lcom/google/android/material/listview/OPListView;->mDisableTouchEvent:Z
    ...
    .line 401
    :cond_3
    iput-boolean v2, p0, Lcom/google/android/material/listview/OPListView;->mAnimRunning:Z

    .line 402
    iget-object v3, p0, Lcom/google/android/material/listview/OPListView;->mDeleteAnimationListener:Lcom/google/android/material/listview/OPListView$DeleteAnimationListener;

    if-eqz v3, :cond_4

    .line 403
    invoke-interface {v3}, Lcom/google/android/material/listview/OPListView$DeleteAnimationListener;->onAnimationStart()V

    .line 405
    :cond_4
    iput-boolean v2, p0, Lcom/google/android/material/listview/OPListView;->mInDeleteAnimation:Z
    ...
    iput v3, p0, Lcom/google/android/material/listview/OPListView;->mOriFirstPosition:I
    ...
    .line 409
    iget v4, p0, Lcom/google/android/material/listview/OPListView;->mOriFirstPosition:I
    ...
    .line 410
    iput-boolean v2, p0, Lcom/google/android/material/listview/OPListView;->mOriLastPage:Z

    goto :goto_0

    .line 412
    :cond_5
    iput-boolean v0, p0, Lcom/google/android/material/listview/OPListView;->mOriLastPage:Z

    .line 415
    :goto_0
    iput v0, p0, Lcom/google/android/material/listview/OPListView;->mOriUpperDeleteCount:I

    .line 416
    iput v0, p0, Lcom/google/android/material/listview/OPListView;->mOriCurDeleteCount:I

    .line 418
    iput v0, p0, Lcom/google/android/material/listview/OPListView;->mOriCurLeftCount:I

    .line 419
    iput v0, p0, Lcom/google/android/material/listview/OPListView;->mOriBelowLeftCount:I
    ...
    iput-object v4, p0, Lcom/google/android/material/listview/OPListView;->mDelOriViewTopList:Ljava/util/ArrayList;
    ...
    .line 426
    :goto_1
    iget-object v4, p0, Lcom/google/android/material/listview/OPListView;->mDelViewList:Ljava/util/ArrayList;
    ...
    iput-object v4, p0, Lcom/google/android/material/listview/OPListView;->mDelViewList:Ljava/util/ArrayList;
    ...
    .line 431
    :goto_2
    iget-object v4, p0, Lcom/google/android/material/listview/OPListView;->mDelPosList:Ljava/util/ArrayList;
    ...
    iput-object v4, p0, Lcom/google/android/material/listview/OPListView;->mDelPosList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v6}, Lcom/google/android/material/listview/OPListView;->getChildAt(I)Landroid/view/View;
    ...
    .line 460
    iput-boolean v0, p0, Lcom/google/android/material/listview/OPListView;->mInDeleteAnimation:Z
    ...
    .line 473
    invoke-virtual {p0, v0}, Lcom/google/android/material/listview/OPListView;->getChildAt(I)Landroid/view/View;
...
.method public setDivider(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 255
    invoke-virtual {p0}, Lcom/google/android/material/listview/OPListView;->requestLayout()V

    .line 256
    invoke-virtual {p0}, Lcom/google/android/material/listview/OPListView;->invalidate()V
