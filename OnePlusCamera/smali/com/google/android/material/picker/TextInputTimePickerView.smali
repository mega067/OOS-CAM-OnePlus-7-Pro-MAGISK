...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    sget v1, Lcom/google/android/material/R$layout;->time_picker_text_input_material:I
    ...
    .line 92
    sget v0, Lcom/google/android/material/R$id;->input_am_pm_parent:I

    invoke-virtual {p0, v0}, Lcom/google/android/material/picker/TextInputTimePickerView;->findViewById(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Landroid/widget/RelativeLayout;

    iput-object v0, p0, Lcom/google/android/material/picker/TextInputTimePickerView;->mAmPmParent:Landroid/widget/RelativeLayout;

    .line 93
    sget v0, Lcom/google/android/material/R$id;->input_block:I

    invoke-virtual {p0, v0}, Lcom/google/android/material/picker/TextInputTimePickerView;->findViewById(I)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/picker/TextInputTimePickerView;->mInputBlock:Landroid/view/View;

    .line 94
    sget v0, Lcom/google/android/material/R$id;->input_hour:I
    ...
    iput-object v0, p0, Lcom/google/android/material/picker/TextInputTimePickerView;->mHourEditText:Landroid/widget/EditText;

    .line 95
    sget v1, Lcom/google/android/material/R$id;->input_minute:I

    invoke-virtual {p0, v1}, Lcom/google/android/material/picker/TextInputTimePickerView;->findViewById(I)Landroid/view/View;

    move-result-object v1

    check-cast v1, Landroid/widget/EditText;

    iput-object v1, p0, Lcom/google/android/material/picker/TextInputTimePickerView;->mMinuteEditText:Landroid/widget/EditText;

    .line 100
    sget v3, Lcom/google/android/material/R$id;->label_error:I

    invoke-virtual {p0, v3}, Lcom/google/android/material/picker/TextInputTimePickerView;->findViewById(I)Landroid/view/View;

    move-result-object v3

    check-cast v3, Landroid/widget/TextView;

    iput-object v3, p0, Lcom/google/android/material/picker/TextInputTimePickerView;->mErrorLabel:Landroid/widget/TextView;

    .line 101
    sget v3, Lcom/google/android/material/R$id;->label_hour:I
    ...
    iput-object v3, p0, Lcom/google/android/material/picker/TextInputTimePickerView;->mHourLabel:Landroid/widget/TextView;

    .line 102
    sget v3, Lcom/google/android/material/R$id;->label_minute:I
    ...
    iput-object v3, p0, Lcom/google/android/material/picker/TextInputTimePickerView;->mMinuteLabel:Landroid/widget/TextView;

    new-array v3, p3, [I

    .line 103
    sget v4, Lcom/google/android/material/R$attr;->pickerColorActivated:I

    const/4 v5, 0x0

    aput v4, v3, v5

    sget v4, Lcom/google/android/material/R$attr;->pickerColorUnActivated:I
    ...
    sget v4, Lcom/google/android/material/R$attr;->pickerInputLabelUnActivated:I
    ...
    sget v6, Lcom/google/android/material/R$integer;->op_control_time_325:I

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v4

    iput v4, p0, Lcom/google/android/material/picker/TextInputTimePickerView;->mLabelAlphaDuration:I

    .line 107
    iget-object v4, p0, Lcom/google/android/material/picker/TextInputTimePickerView;->mTimeColorStates:[I
    ...
    .line 114
    new-instance p2, Lcom/google/android/material/picker/TextInputTimePickerView$1;

    invoke-direct {p2, p0}, Lcom/google/android/material/picker/TextInputTimePickerView$1;-><init>(Lcom/google/android/material/picker/TextInputTimePickerView;)V

    invoke-virtual {v0, p2}, Landroid/widget/EditText;->setOnFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V

    .line 132
    new-instance p2, Lcom/google/android/material/picker/TextInputTimePickerView$2;

    invoke-direct {p2, p0}, Lcom/google/android/material/picker/TextInputTimePickerView$2;-><init>(Lcom/google/android/material/picker/TextInputTimePickerView;)V

    invoke-virtual {v1, p2}, Landroid/widget/EditText;->setOnFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V

    .line 149
    new-instance p2, Lcom/google/android/material/picker/TextInputTimePickerView$3;

    invoke-direct {p2, p0}, Lcom/google/android/material/picker/TextInputTimePickerView$3;-><init>(Lcom/google/android/material/picker/TextInputTimePickerView;)V

    invoke-virtual {v0, p2}, Landroid/widget/EditText;->addTextChangedListener(Landroid/text/TextWatcher;)V

    .line 165
    new-instance p2, Lcom/google/android/material/picker/TextInputTimePickerView$4;

    invoke-direct {p2, p0}, Lcom/google/android/material/picker/TextInputTimePickerView$4;-><init>(Lcom/google/android/material/picker/TextInputTimePickerView;)V
    ...
    invoke-virtual {p0, p2}, Lcom/google/android/material/picker/TextInputTimePickerView;->findViewById(I)Landroid/view/View;
    ...
    .line 184
    invoke-virtual {p2, p4}, Landroid/widget/RadioButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-static {p0}, Lcom/google/android/material/picker/TimePickerClockDelegate;->obtainVerbatim(Ljava/lang/String;)Ljava/lang/CharSequence;

    move-result-object p0

    invoke-virtual {p2, p0}, Landroid/widget/RadioButton;->setText(Ljava/lang/CharSequence;)V
...
.method private resetInputTimeTextAppearance(ILandroid/widget/TextView;)V
    ...
    .line 210
    :cond_0
    invoke-virtual {p0}, Lcom/google/android/material/picker/TextInputTimePickerView;->getContext()Landroid/content/Context;
...
.method public setAmPmAtStart(Z)V
    ...
    invoke-virtual {p0}, Lcom/google/android/material/picker/TextInputTimePickerView;->getResources()Landroid/content/res/Resources;
