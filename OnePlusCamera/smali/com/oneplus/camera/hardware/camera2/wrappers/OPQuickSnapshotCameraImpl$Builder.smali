.class public final Lcom/oneplus/camera/hardware/camera2/wrappers/OPQuickSnapshotCameraImpl$Builder;
...
.method public constructor <init>()V
    ...
    .line 127
    const-class v0, Lcom/oneplus/camera/hardware/camera2/wrappers/OPQuickSnapshotCameraImpl;
...
# virtual methods
.method public build(Lcom/oneplus/camera/next/hardware/Camera;)Lcom/oneplus/camera/hardware/camera2/wrappers/OPQuickSnapshotCameraImpl;
    .locals 2
    ...
    .line 144
    :cond_2
    sget-object p0, Lcom/oneplus/camera/next/hardware/QuickSnapshotCamera;->Companion:Lcom/oneplus/camera/next/hardware/QuickSnapshotCamera$Companion;

    invoke-virtual {p0}, Lcom/oneplus/camera/next/hardware/QuickSnapshotCamera$Companion;->getFEATURE_IS_ENABLED()Lcom/oneplus/util/Feature;
    ...
    .line 148
    :cond_3
    new-instance p0, Lcom/oneplus/camera/hardware/camera2/wrappers/OPQuickSnapshotCameraImpl;

    check-cast p1, Lcom/oneplus/camera/next/hardware/camera2/Camera2;

    invoke-direct {p0, p1, v0}, Lcom/oneplus/camera/hardware/camera2/wrappers/OPQuickSnapshotCameraImpl;-><init>(Lcom/oneplus/camera/next/hardware/camera2/Camera2;Lkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public bridge synthetic build(Lcom/oneplus/camera/next/hardware/Camera;)Lcom/oneplus/camera/next/hardware/Camera;
    ...
    .line 127
    invoke-virtual {p0, p1}, Lcom/oneplus/camera/hardware/camera2/wrappers/OPQuickSnapshotCameraImpl$Builder;->build(Lcom/oneplus/camera/next/hardware/Camera;)Lcom/oneplus/camera/hardware/camera2/wrappers/OPQuickSnapshotCameraImpl;
