...
.method private final onLoadFeatures()V
    ...
    const-string v0, "features.override"

    const/4 v1, 0x0

    .line 311
    invoke-virtual {p0, v0, v1}, Lcom/oneplus/camera/CameraApp;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    ...
    invoke-virtual {v1}, Lcom/oneplus/base/HardwarePlatform$Companion;->getFEATURE_PREDEFINED_HW_PLATFORM()Lcom/oneplus/util/Feature;
    ...
    const-string v4, "onLoadFeatures() - Predefined hardware platform: "
    ...
    invoke-virtual {v2}, Lcom/oneplus/base/HardwarePlatform$Companion;->getFEATURE_PREDEFINED_HW_PLATFORM()Lcom/oneplus/util/Feature;

    move-result-object v2

    check-cast v1, Ljava/lang/CharSequence;

    invoke-virtual {v2, v1}, Lcom/oneplus/util/Feature;->set(Ljava/lang/CharSequence;)V

    .line 311
    :cond_0
    iput-object v0, p0, Lcom/oneplus/camera/CameraApp;->savedFeaturesPreferences:Landroid/content/SharedPreferences;
    ...
    .line 334
    invoke-static {}, Lcom/oneplus/camera/features/OPlusFeaturesKt;->initializeOPlusFeatures()V
    ...
    .line 344
    iget-object v2, p0, Lcom/oneplus/camera/CameraApp;->savedFeaturesPreferences:Landroid/content/SharedPreferences;
    ...
    const-string v1, " ms to load overridden feature(s)"
...
.method protected onCreate()V
    ...
    .line 220
    invoke-virtual {p0, v0, v1}, Lcom/oneplus/camera/CameraApp;->getDir(Ljava/lang/String;I)Ljava/io/File;

    move-result-object v0

    invoke-static {v0}, Lcom/oneplus/base/MemoryMonitor;->setHeapDumpDirectory(Ljava/io/File;)V

    .line 221
    sget-object v0, Lcom/oneplus/camera/CameraApp;->FEATURE_MEMORY_MONITOR_WARN_THRESHOLD:Lcom/oneplus/util/Feature;
    ...
    .line 222
    sget-object v0, Lcom/oneplus/camera/CameraApp;->FEATURE_MEMORY_MONITOR_HIGH_RISK_THRESHOLD:Lcom/oneplus/util/Feature;
    ...
    .line 223
    sget-object v0, Lcom/oneplus/camera/CameraApp;->FEATURE_MEMORY_MONITOR_DANGEROUS_THRESHOLD:Lcom/oneplus/util/Feature;
    ...
    .line 227
    sget-object v0, Lcom/oneplus/base/component/ComponentManager;->FEATURE_PROFILE_COMPONENT_CREATION:Lcom/oneplus/util/Feature;

    invoke-virtual {v0, v2}, Lcom/oneplus/util/Feature;->set(Z)V

    .line 230
    :cond_1
    new-instance v0, Lcom/oneplus/camera/CameraSettings;
    ...
    iput-object v0, p0, Lcom/oneplus/camera/CameraApp;->settings:Lcom/oneplus/camera/CameraSettings;
    ...
    invoke-virtual {v3, v4, v1}, Lcom/oneplus/camera/CameraSettings;->getBoolean(Ljava/lang/String;Z)Z
    ...
    :goto_0
    invoke-virtual {p0, v0, v3}, Lcom/oneplus/camera/CameraApp;->setReadOnly(Lcom/oneplus/base/PropertyKey;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v7, v2}, Lcom/oneplus/base/component/ComponentManager;->createComponents(Lcom/oneplus/base/component/ComponentCreationPriority;[Ljava/lang/Object;)V
