.class public Lco/polarr/renderer/o/c;
...
.method public static a(Lco/polarr/renderer/entities/Context;IIZ[F)F
    ...
    invoke-static {p0}, Lco/polarr/renderer/o/c;->c(Lco/polarr/renderer/entities/Context;)F
...
.method public static a(Lco/polarr/renderer/entities/Context;FF)V
    ...
    .line 42
    invoke-static {v0, v1, v2, v3, v4}, Lco/polarr/renderer/o/h;->a([FFIFI)V
...
.method public static a(Lco/polarr/renderer/entities/Context;)[F
    ...
    invoke-static {v5, p0}, Lco/polarr/renderer/e;->a(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/Object;
...
.method public static b(Lco/polarr/renderer/entities/Context;)[F
    ...
    iget p0, p0, Lco/polarr/renderer/render/f;->b:I
...
.method public static c(Lco/polarr/renderer/entities/Context;)F
    ...
    .line 1
    sget v0, Lco/polarr/renderer/o/c;->a:F
    ...
    sput p0, Lco/polarr/renderer/o/c;->a:F

    .line 4
    :cond_0
    sget p0, Lco/polarr/renderer/o/c;->a:F
...
.method public static d(Lco/polarr/renderer/entities/Context;)V
    ...
    invoke-static {v4, v3}, Lco/polarr/renderer/e;->a(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/Object;
    ...
    .line 8
    invoke-static/range {p0 .. p0}, Lco/polarr/renderer/o/c;->a(Lco/polarr/renderer/entities/Context;)[F
    ...
    .line 15
    invoke-static/range {p0 .. p0}, Lco/polarr/renderer/o/c;->b(Lco/polarr/renderer/entities/Context;)[F
    ...
    iget-object v11, v9, Lco/polarr/renderer/entities/Context$Screen;->offset:[F

    aget v11, v11, v14

    neg-float v11, v11

    iget-object v9, v9, Lco/polarr/renderer/entities/Context$Screen;->center:[F
    ...
    invoke-static/range {p0 .. p0}, Lco/polarr/renderer/o/c;->c(Lco/polarr/renderer/entities/Context;)F
    ...
    iget-object v8, v9, Lco/polarr/renderer/entities/Context$Screen;->offset:[F
    ...
    iput v9, v7, Lco/polarr/renderer/entities/Context$Overlay;->imageWidth:F
    ...
    invoke-static {v7, v5}, Lco/polarr/renderer/e;->a(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/Object;
    ...
    const-string v9, "flip_y"

    invoke-static {v9, v7}, Lco/polarr/renderer/e;->a(Ljava/lang/String;Ljava/util/Map;)Ljava/lang/Object;
    ...
    .line 53
    :goto_2
    iget-object v9, v0, Lco/polarr/renderer/entities/Context;->overlay:Lco/polarr/renderer/entities/Context$Overlay;
    ...
    :goto_3
    iput v5, v9, Lco/polarr/renderer/entities/Context$Overlay;->flipX:I
    ...
    .line 107
    invoke-static {v1, v14, v13}, Lco/polarr/renderer/o/h;->a([FZZ)[F
