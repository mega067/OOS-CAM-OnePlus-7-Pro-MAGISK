.class public final Lcom/oneplus/camera/EventTracker$Companion;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "",
        "()V",
        "EVENT_NAME_AUTO_SWITCHED_TO_FRONT_WIDE_CAMERA",
        "",
        "EVENT_NAME_CAMERA_PREVIEW_ELAPSED_TIME",
        "EVENT_NAME_CAMERA_SETTINGS",
        "EVENT_NAME_CAMERA_SMART",
        "EVENT_NAME_CAPTURE",
        "EVENT_NAME_CAPTURE_AUTO_SWITCHED_TO_MACRO",
        "EVENT_NAME_CAPTURE_BOKEH",
        "EVENT_NAME_CAPTURE_MACRO",
        "EVENT_NAME_CAPTURE_MANUAL",
        "EVENT_NAME_CAPTURE_NIGHT",
        "EVENT_NAME_CAPTURE_PANORAMA",
        "EVENT_NAME_CAPTURE_PHOTO",
        "EVENT_NAME_CAPTURE_SELF",
        "EVENT_NAME_CAPTURE_SLOMO",
        "EVENT_NAME_CAPTURE_TIMELAPSE",
        "EVENT_NAME_CAPTURE_VIDEO_BACK",
        "EVENT_NAME_CAPTURE_VIDEO_FRONT",
        "EVENT_NAME_CHANGE_ZOOM",
        "EVENT_NAME_CUSTOMIZED_MODES",
        "EVENT_NAME_LAUNCH",
        "EVENT_NAME_QUICK_SHARE",
        "EVENT_NAME_QUICK_VIDEO",
        "EVENT_NAME_SWITCH_CAMERA",
        "EVENT_NAME_SWITCH_MODE",
        "PARAM_CAMERA_PREVIEW_TIME",
        "PARAM_CAMERA_SETTINGS_LONG_PRESS_BEHAVIOR",
        "PARAM_CAMERA_SETTINGS_OBJECT_TRACKING",
        "PARAM_CAMERA_SETTINGS_SCENE_DETECTION",
        "PARAM_CAMERA_SETTINGS_TRIPOD_LONG",
        "PARAM_CAMERA_SETTINGS_ULTRASHOT_HDR",
        "PARAM_CAMERA_SETTINGS_ULTRAWIDE_CORRECTION",
        "PARAM_CAMERA_SMART_ACTIVITY",
        "PARAM_CAMERA_SMART_TYPE",
        "PARAM_CAMERA_STORAGE_TO_SD_CARD",
        "PARAM_CAPTURE_BOKEH_FACE_BEAUTY",
        "PARAM_CAPTURE_BOKEH_FACE_COUNT",
        "PARAM_CAPTURE_BOKEH_FILTER",
        "PARAM_CAPTURE_BOKEH_FINGER",
        "PARAM_CAPTURE_BOKEH_WATERMARK",
        "PARAM_CAPTURE_BOKEH_ZOOM",
        "PARAM_CAPTURE_CAMERA_FACING",
        "PARAM_CAPTURE_EXPOSURE_COMPENSATION",
        "PARAM_CAPTURE_EXPOSURE_LOCK",
        "PARAM_CAPTURE_FLASH_MODE",
        "PARAM_CAPTURE_GRID",
        "PARAM_CAPTURE_LIGHTING",
        "PARAM_CAPTURE_LOCATION",
        "PARAM_CAPTURE_MACRO_ZOOM_NUM",
        "PARAM_CAPTURE_MANUAL_FINGER",
        "PARAM_CAPTURE_MANUAL_FOCUS",
        "PARAM_CAPTURE_MANUAL_IMAGE_FORMAT",
        "PARAM_CAPTURE_MANUAL_ISO",
        "PARAM_CAPTURE_MANUAL_IS_AE_AF_SEPARATED",
        "PARAM_CAPTURE_MANUAL_IS_CUSTOMIZED_MODE",
        "PARAM_CAPTURE_MANUAL_IS_HISTOGRAM_ON",
        "PARAM_CAPTURE_MANUAL_SHUTTER_SPEED",
        "PARAM_CAPTURE_MANUAL_WATERMARK",
        "PARAM_CAPTURE_MANUAL_WHITE_BALANCE",
        "PARAM_CAPTURE_MEDIA_TYPE",
        "PARAM_CAPTURE_MODE",
        "PARAM_CAPTURE_NIGHT_SID",
        "PARAM_CAPTURE_NIGHT_TRIPOD",
        "PARAM_CAPTURE_NIGHT_ZOOM",
        "PARAM_CAPTURE_PANORAMA_CAPTURED_LENGTH",
        "PARAM_CAPTURE_PANORAMA_FINGER",
        "PARAM_CAPTURE_PANORAMA_IS_STOPPED_BY_USER",
        "PARAM_CAPTURE_PANORAMA_RESULT",
        "PARAM_CAPTURE_PHOTO_AWB_CCT",
        "PARAM_CAPTURE_PHOTO_FACE_BEAUTY",
        "PARAM_CAPTURE_PHOTO_FILTER",
        "PARAM_CAPTURE_PHOTO_FINGER",
        "PARAM_CAPTURE_PHOTO_IS_BURST",
        "PARAM_CAPTURE_PHOTO_MACRO",
        "PARAM_CAPTURE_PHOTO_MACRO_AUTO",
        "PARAM_CAPTURE_PHOTO_PICTURE_COUNT",
        "PARAM_CAPTURE_PHOTO_RATIO",
        "PARAM_CAPTURE_PHOTO_RESOLUTION",
        "PARAM_CAPTURE_PHOTO_SCENE_RECOGNITION",
        "PARAM_CAPTURE_PHOTO_SELF_TIMER",
        "PARAM_CAPTURE_PHOTO_VIDEO_SNAP",
        "PARAM_CAPTURE_PHOTO_WATER_MARK",
        "PARAM_CAPTURE_PHOTO_ZOOM",
        "PARAM_CAPTURE_QUICK_VIDEO_IS_LOCK_ON",
        "PARAM_CAPTURE_QUICK_VIDEO_VOLUME_KEY",
        "PARAM_CAPTURE_ROTATION",
        "PARAM_CAPTURE_SCENE",
        "PARAM_CAPTURE_SELF_AI_CLARITY",
        "PARAM_CAPTURE_SELF_AUTO_FRON_UW",
        "PARAM_CAPTURE_SELF_FACE_BEAUTY",
        "PARAM_CAPTURE_SELF_FACE_COUNT",
        "PARAM_CAPTURE_SELF_FILTER",
        "PARAM_CAPTURE_SELF_FINGER",
        "PARAM_CAPTURE_SELF_LENS_TYPE",
        "PARAM_CAPTURE_SELF_TIMER",
        "PARAM_CAPTURE_SHUTTER_SOUND",
        "PARAM_CAPTURE_SLOMO_DURATION",
        "PARAM_CAPTURE_SLOMO_PAUSE_VIDEO",
        "PARAM_CAPTURE_SLOMO_RESOLUTION",
        "PARAM_CAPTURE_TAP_FOCUS",
        "PARAM_CAPTURE_TIMELAPSE_RESOLUTION",
        "PARAM_CAPTURE_TRIGGERED_BUTTON",
        "PARAM_CAPTURE_VIDEO_DURATION",
        "PARAM_CAPTURE_VIDEO_NIGHTSCAPE",
        "PARAM_CAPTURE_VIDEO_PAUSE_VIDEO",
        "PARAM_CAPTURE_VIDEO_RESOLUTION",
        "PARAM_CAPTURE_VIDEO_SUPER_STEADY",
        "PARAM_CAPTURE_VIDEO_VIDEO_FILTER",
        "PARAM_CAPTURE_VIDEO_VIDEO_HDR",
        "PARAM_CAPTURE_VIDEO_VIDEO_PORTRAIT",
        "PARAM_CAPTURE_VIDEO_VIDEO_SNAP",
        "PARAM_CAPTURE_VIDEO_ZOOM",
        "PARAM_CHANGE_ZOOM_SOURCE",
        "PARAM_CUSTOMIZED_MODES_NIGHTSCAPE",
        "PARAM_CUSTOMIZED_MODES_PANO",
        "PARAM_CUSTOMIZED_MODES_PORTRAIT",
        "PARAM_CUSTOMIZED_MODES_PRO",
        "PARAM_CUSTOMIZED_MODES_SLOMO",
        "PARAM_CUSTOMIZED_MODES_TIMELAPSE",
        "PARAM_FINGERPRINT_LONG_PRESS_TO_TAKE_PHOTO",
        "PARAM_LAUNCH_SOURCE",
        "PARAM_LAUNCH_START_MODE",
        "PARAM_QUICK_SHARE_APP",
        "PARAM_QUICK_SHARE_CHANNEL",
        "PARAM_QUICK_SHARE_CONTENT",
        "PARAM_SWITCH_CAMERA_CAMERA_SOURCE",
        "PARAM_SWITCH_MODE_MODE_SOURCE",
...
# static fields
.field static final synthetic $$INSTANCE:Lcom/oneplus/camera/EventTracker$Companion;
...
.method static constructor <clinit>()V
    ...
    .line 13
    new-instance v0, Lcom/oneplus/camera/EventTracker$Companion;

    invoke-direct {v0}, Lcom/oneplus/camera/EventTracker$Companion;-><init>()V

    sput-object v0, Lcom/oneplus/camera/EventTracker$Companion;->$$INSTANCE:Lcom/oneplus/camera/EventTracker$Companion;
