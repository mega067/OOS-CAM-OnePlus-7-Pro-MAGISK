...
.method public final invoke()V
    ...
    check-cast v4, Lcom/oneplus/camera/next/media/AnonymousNativeImage;

    .line 234
    iget-object v5, v1, Lcom/oneplus/camera/hardware/camera2/wrappers/watermark/OPWatermarkCameraImpl$onPictureCaptured$$inlined$let$lambda$1;->this$0:Lcom/oneplus/camera/hardware/camera2/wrappers/watermark/OPWatermarkCameraImpl;

    invoke-static {v5}, Lcom/oneplus/camera/hardware/camera2/wrappers/watermark/OPWatermarkCameraImpl;->access$getTAG$p(Lcom/oneplus/camera/hardware/camera2/wrappers/watermark/OPWatermarkCameraImpl;)Ljava/lang/String;

    move-result-object v5

    const-string v6, "onPictureCaptured() - Apply watermark [start]"
    ...
    invoke-static {v8, v5}, Lcom/oneplus/camera/next/media/ImageKt;->tryConvertToNV21(Lcom/oneplus/camera/next/media/Image;Lcom/oneplus/camera/next/media/Image;)Z
    ...
    .line 504
    sget-object v7, Lcom/oneplus/interop/NativeMemory;->Companion:Lcom/oneplus/interop/NativeMemory$Companion;

    invoke-virtual {v7, v0}, Lcom/oneplus/interop/NativeMemory$Companion;->lockArray([B)J
    ...
    invoke-virtual {v5}, Lcom/oneplus/camera/next/media/NativeImageHandle;->getHandle()J
    ...
    const-string v5, "onPictureCaptured() - Apply watermark [end]"
