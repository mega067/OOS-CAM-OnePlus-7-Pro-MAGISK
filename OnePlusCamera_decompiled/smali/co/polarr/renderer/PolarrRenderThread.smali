...
.field private b:Lco/polarr/renderer/k;
...
.method public constructor <init>(Landroid/content/res/Resources;)V
    ...
    .line 2
    iput-object v0, p0, Lco/polarr/renderer/PolarrRenderThread;->b:Lco/polarr/renderer/k;
...
.method static synthetic a(Lco/polarr/renderer/PolarrRenderThread;)Lco/polarr/renderer/k;
    .locals 0

    .line 1
    iget-object p0, p0, Lco/polarr/renderer/PolarrRenderThread;->b:Lco/polarr/renderer/k;
...
.method private a()V
    ...
    .line 6
    new-instance v2, Lco/polarr/renderer/k;

    invoke-direct {v2}, Lco/polarr/renderer/k;-><init>()V

    iput-object v2, p0, Lco/polarr/renderer/PolarrRenderThread;->b:Lco/polarr/renderer/k;
    ...
    invoke-virtual/range {v2 .. v7}, Lco/polarr/renderer/k;->a(Landroid/content/res/Resources;IIZI)V
...
.method private b()V
    ...
    .line 2
    iget-object v0, p0, Lco/polarr/renderer/PolarrRenderThread;->b:Lco/polarr/renderer/k;

    invoke-virtual {v0}, Lco/polarr/renderer/k;->p()V

    .line 3
    iget-object p0, p0, Lco/polarr/renderer/PolarrRenderThread;->c:Lco/polarr/renderer/render/a;

    invoke-virtual {p0}, Lco/polarr/renderer/render/a;->a()V
...
.method public interrupt()V
    ...
    new-instance v1, Lco/polarr/renderer/PolarrRenderThread$d;

    invoke-direct {v1, p0}, Lco/polarr/renderer/PolarrRenderThread$d;-><init>(Lco/polarr/renderer/PolarrRenderThread;)V
...
.method public renderBitmap(Landroid/graphics/Bitmap;Ljava/util/List;Lco/polarr/renderer/RenderCallback;)V
    ...
    new-instance v1, Lco/polarr/renderer/PolarrRenderThread$a;

    invoke-direct {v1, p0, p1, p2, p3}, Lco/polarr/renderer/PolarrRenderThread$a;-><init>(Lco/polarr/renderer/PolarrRenderThread;Landroid/graphics/Bitmap;Ljava/util/List;Lco/polarr/renderer/RenderCallback;)V
...
.method public renderBitmapByStates(Landroid/graphics/Bitmap;Ljava/util/List;Lco/polarr/renderer/RenderCallback;)V
    ...
    new-instance v1, Lco/polarr/renderer/PolarrRenderThread$b;

    invoke-direct {v1, p0, p3, p1, p2}, Lco/polarr/renderer/PolarrRenderThread$b;-><init>(Lco/polarr/renderer/PolarrRenderThread;Lco/polarr/renderer/RenderCallback;Landroid/graphics/Bitmap;Ljava/util/List;)V
...
.method public declared-synchronized start()V
    ...
    .line 3
    new-instance v1, Lco/polarr/renderer/PolarrRenderThread$c;

    invoke-direct {v1, p0}, Lco/polarr/renderer/PolarrRenderThread$c;-><init>(Lco/polarr/renderer/PolarrRenderThread;)V
