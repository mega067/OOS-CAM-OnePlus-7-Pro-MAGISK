...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;

    const-string v3, "RESTRUCTURE_AFTER"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;->RESTRUCTURE_AFTER:Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;

    new-instance v3, Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;

    const-string v5, "SKIP_IF_EMPTY"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;->SKIP_IF_EMPTY:Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;

    new-instance v5, Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;

    const-string v7, "RESIZE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;->RESIZE:Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;
    ...
    .line 780
    sput-object v7, Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;->$VALUES:[Lcom/oneplus/utils/reflection/utils/ConcurrentReferenceHashMap$TaskOption;
