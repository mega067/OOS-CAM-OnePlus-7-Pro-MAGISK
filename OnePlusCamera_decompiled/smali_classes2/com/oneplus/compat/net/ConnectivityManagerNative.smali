...
.method private static generateDefaultConstructor(Lcom/android/dx/DexMaker;Lcom/android/dx/TypeId;)V
    ...
    new-array v2, v0, [Lcom/android/dx/TypeId;

    invoke-virtual {v1, v2}, Lcom/android/dx/TypeId;->getConstructor([Lcom/android/dx/TypeId;)Lcom/android/dx/MethodId;
    ...
    invoke-virtual {p0, v1, v2, p1, v0}, Lcom/android/dx/Code;->invokeDirect(Lcom/android/dx/MethodId;Lcom/android/dx/Local;Lcom/android/dx/Local;[Lcom/android/dx/Local;)V
...
.method private static generateMethods(Lcom/android/dx/DexMaker;Lcom/android/dx/TypeId;)V
    ...
    .line 94
    invoke-virtual {p0, v0, v1}, Lcom/android/dx/DexMaker;->declare(Lcom/android/dx/MethodId;I)Lcom/android/dx/Code;
    ...
    .line 96
    invoke-virtual {p0, p1, v1}, Lcom/android/dx/DexMaker;->declare(Lcom/android/dx/MethodId;I)Lcom/android/dx/Code;
...
.method private static getEmptyOnStartTetheringCallback(Landroid/content/Context;)Ljava/lang/Object;
    ...
    const-string v2, "Landroid/net/ConnectivityManager$OnStartTetheringCallback;"
    ...
    new-array v7, v2, [Lcom/android/dx/TypeId;

    const-string v4, "OnStartTetheringCallback.generated"
    ...
    .line 71
    invoke-static {v0, v1}, Lcom/oneplus/compat/net/ConnectivityManagerNative;->generateDefaultConstructor(Lcom/android/dx/DexMaker;Lcom/android/dx/TypeId;)V

    .line 72
    invoke-static {v0, v1}, Lcom/oneplus/compat/net/ConnectivityManagerNative;->generateMethods(Lcom/android/dx/DexMaker;Lcom/android/dx/TypeId;)V
    ...
    invoke-virtual {v0, v1, p0}, Lcom/android/dx/DexMaker;->generateAndLoad(Ljava/lang/ClassLoader;Ljava/io/File;)Ljava/lang/ClassLoader;

    move-result-object p0

    const-string v0, "OnStartTetheringCallback"
...
.method public static startTethering(Landroid/net/ConnectivityManager;IZLandroid/content/Context;)V
    ...
    .line 46
    invoke-static {v1, v0, v3}, Lcom/oneplus/utils/reflection/MethodReflection;->findMethod(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
