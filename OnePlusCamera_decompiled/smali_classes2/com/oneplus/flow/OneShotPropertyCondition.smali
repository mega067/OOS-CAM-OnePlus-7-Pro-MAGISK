...
.method public constructor <init>(Lcom/oneplus/base/PropertySource;Lcom/oneplus/base/PropertyKey;Lkotlin/jvm/functions/Function1;)V
    ...
    .line 17
    invoke-interface {p1, p2}, Lcom/oneplus/base/PropertySource;->get(Lcom/oneplus/base/PropertyKey;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/oneplus/flow/OneShotPropertyCondition;->changeCallback:Lcom/oneplus/base/PropertyChangedCallback;
    ...
    .line 24
    :cond_0
    new-instance p3, Lcom/oneplus/flow/OneShotPropertyCondition$1;

    invoke-direct {p3, p0}, Lcom/oneplus/flow/OneShotPropertyCondition$1;-><init>(Lcom/oneplus/flow/OneShotPropertyCondition;)V

    check-cast p3, Lcom/oneplus/base/PropertyChangedCallback;

    iput-object p3, p0, Lcom/oneplus/flow/OneShotPropertyCondition;->changeCallback:Lcom/oneplus/base/PropertyChangedCallback;

    .line 37
    instance-of v1, p1, Lcom/oneplus/base/HandlerObject;
    ...
    .line 41
    new-instance p1, Lcom/oneplus/flow/OneShotPropertyCondition$2;

    invoke-direct {p1, p0}, Lcom/oneplus/flow/OneShotPropertyCondition$2;-><init>(Lcom/oneplus/flow/OneShotPropertyCondition;)V

    check-cast p1, Lkotlin/jvm/functions/Function0;

    .line 40
    invoke-static {v0, p1}, Lcom/oneplus/base/HandlersKt;->post(Lcom/oneplus/base/HandlerObject;Lkotlin/jvm/functions/Function0;)Z

    goto :goto_1

    .line 49
    :cond_2
    invoke-interface {p1, p2, p3}, Lcom/oneplus/base/PropertySource;->addCallback(Lcom/oneplus/base/PropertyKey;Lcom/oneplus/base/PropertyChangedCallback;)V
...
.method public release()V
    ...
    .line 66
    iget-object v1, p0, Lcom/oneplus/flow/OneShotPropertyCondition;->owner:Lcom/oneplus/base/PropertySource;

    instance-of v2, v1, Lcom/oneplus/base/HandlerObject;
    ...
    :goto_0
    check-cast v2, Lcom/oneplus/base/HandlerObject;

    if-eqz v2, :cond_1

    .line 70
    new-instance v0, Lcom/oneplus/flow/OneShotPropertyCondition$release$1;

    invoke-direct {v0, p0}, Lcom/oneplus/flow/OneShotPropertyCondition$release$1;-><init>(Lcom/oneplus/flow/OneShotPropertyCondition;)V

    check-cast v0, Lkotlin/jvm/functions/Function0;

    .line 69
    invoke-static {v2, v0}, Lcom/oneplus/base/HandlersKt;->post(Lcom/oneplus/base/HandlerObject;Lkotlin/jvm/functions/Function0;)Z

    goto :goto_1

    .line 75
    :cond_1
    iget-object v2, p0, Lcom/oneplus/flow/OneShotPropertyCondition;->key:Lcom/oneplus/base/PropertyKey;

    invoke-interface {v1, v2, v0}, Lcom/oneplus/base/PropertySource;->removeCallback(Lcom/oneplus/base/PropertyKey;Lcom/oneplus/base/PropertyChangedCallback;)V
