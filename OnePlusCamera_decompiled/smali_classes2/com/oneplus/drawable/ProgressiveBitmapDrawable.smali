...
.method private decodeBitmapInfoAsync()V
    ...
    .line 380
    :cond_4
    instance-of v7, v6, Lcom/oneplus/io/StreamSource;
...
.method private decodeTilesAsync(Lcom/oneplus/drawable/ProgressiveBitmapDrawable$BitmapTilesDecodingTask;)V
    ...
    invoke-static {v0, v4, v4, v3, v1}, Lcom/oneplus/media/ImageUtils;->decodeBitmap(Ljava/lang/String;IIILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 523
    :try_start_7
    iget-object v2, v8, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_ContentResolver:Landroid/content/ContentResolver;
    ...
    invoke-static {v2, v4, v4, v3, v0}, Lcom/oneplus/media/ImageUtils;->decodeBitmap(Ljava/io/InputStream;IIILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 533
    :cond_c
    instance-of v2, v0, Lcom/oneplus/io/StreamSource;
    :try_end_d
    ...
    iget-object v2, v8, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_CancelStreamOpeningRef:Lcom/oneplus/base/Ref;

    invoke-interface {v0, v2}, Lcom/oneplus/io/StreamSource;->openInputStream(Lcom/oneplus/base/Ref;)Ljava/io/InputStream;
...
.method private startDecodingBitmapTiles()V
    ...
    .line 1328
    sget-object p0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_DecodingExecutors:Ljava/util/concurrent/Executor;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 655
    sget-object v11, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_DecodingExecutors:Ljava/util/concurrent/Executor;
    ...
    .line 665
    sget-object v8, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_DecodingExecutors:Ljava/util/concurrent/Executor;
    ...
    const-string v11, "ProgressiveBitmapDrawable"

    const-string v12, "draw() - Change sample size from "
    ...
    invoke-static {v11, v12, v8, v13, v14}, Lcom/oneplus/base/Log;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    const-string v7, "draw() - Start tile ["
    ...
    .line 723
    iget v1, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_StartTileX:I
    ...
    iget v1, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_StartTileY:I
    ...
    .line 723
    invoke-static {v2, v7, v10}, Lcom/oneplus/base/Log;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 730
    iget v4, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_StartTileY:I

    if-lt v14, v4, :cond_d

    iget v4, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_EndTileY:I

    if-gt v14, v4, :cond_d

    iget v4, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_StartTileX:I

    if-lt v2, v4, :cond_d

    iget v4, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_EndTileX:I
    ...
    .line 733
    iget-object v5, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_Tiles:[[Lcom/oneplus/drawable/ProgressiveBitmapDrawable$Tile;
    ...
    .line 734
    iget-boolean v7, v5, Lcom/oneplus/drawable/ProgressiveBitmapDrawable$Tile;->isValid:Z

    if-eqz v7, :cond_14

    iget-object v7, v5, Lcom/oneplus/drawable/ProgressiveBitmapDrawable$Tile;->bitmap:Landroid/graphics/Bitmap;

    if-nez v7, :cond_14

    iget-boolean v7, v5, Lcom/oneplus/drawable/ProgressiveBitmapDrawable$Tile;->isDecoding:Z

    if-nez v7, :cond_14

    .line 739
    iget-object v7, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_TileUsageQueue:Ljava/util/LinkedList;
    ...
    const-string v19, "ProgressiveBitmapDrawable"

    const-string v20, "draw() - Queue is full, ignore pre-decode ["
    ...
    invoke-static/range {v19 .. v24}, Lcom/oneplus/base/Log;->v(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v10}, Lcom/oneplus/drawable/ProgressiveBitmapDrawable$Tile;->reset()V
    ...
    const-string v20, "draw() - Drop pre-decode ["
    ...
    invoke-virtual {v7, v4}, Ljava/util/LinkedList;->addFirst(Ljava/lang/Object;)V

    .line 769
    iget-object v7, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_TileDecodingQueue:Ljava/util/Queue;
    ...
    const-string v20, "draw() - Pre-decode ["
    ...
    invoke-interface {v9, v4}, Ljava/util/Queue;->add(Ljava/lang/Object;)Z

    .line 774
    iget-object v4, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_TileDecodingQueue:Ljava/util/Queue;
    ...
    .line 776
    iput-boolean v4, v5, Lcom/oneplus/drawable/ProgressiveBitmapDrawable$Tile;->isDecoding:Z
    ...
    const-string v20, "draw() - Position ["
    ...
    .line 827
    invoke-virtual {v13, v1, v6, v8, v11}, Landroid/graphics/RectF;->set(FFFF)V

    .line 833
    iget-object v1, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_DestDrawingBounds:Landroid/graphics/RectF;
    ...
    .line 836
    iget-wide v13, v10, Lcom/oneplus/drawable/ProgressiveBitmapDrawable$Tile;->fadeInAnimationStartTime:J
    ...
    .line 849
    iget-object v8, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_SrcDrawingBounds:Landroid/graphics/Rect;
    ...
    invoke-virtual {v11, v12, v8, v9, v10}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    iget-object v14, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_Paint:Landroid/graphics/Paint;

    invoke-virtual {v11, v12, v6, v13, v14}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/RectF;Landroid/graphics/Paint;)V

    .line 856
    iput-wide v8, v10, Lcom/oneplus/drawable/ProgressiveBitmapDrawable$Tile;->fadeInAnimationStartTime:J
    ...
    const-string v3, "draw() - No need to draw, original size : "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_OriginalWidth:I
    ...
    iget v3, v0, Lcom/oneplus/drawable/ProgressiveBitmapDrawable;->m_OriginalHeight:I

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v2

    const-string v3, ", HQ bitmap enabled : "
