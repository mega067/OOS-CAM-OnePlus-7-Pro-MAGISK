...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/oneplus/gl/GLThread;->EGL_CONFIG_ATTRS_ARGB:[I
...
.method private createEglSurface(Lcom/oneplus/gl/GLThread$EglSurfaceHandle;)Z
    ...
    .line 315
    :cond_2
    iget-object p0, p0, Lcom/oneplus/gl/GLThread;->TAG:Ljava/lang/String;

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "createEglSurface() - EGL surface : "
    ...
    iget v3, p1, Lcom/oneplus/gl/GLThread$EglSurfaceHandle;->height:I
...
.method private destroyEglSurface(Lcom/oneplus/gl/GLThread$EglSurfaceHandle;)V
    ...
    .line 380
    iget-object p0, p0, Lcom/oneplus/gl/GLThread;->m_EglDisplay:Landroid/opengl/EGLDisplay;

    iget-object v0, p1, Lcom/oneplus/gl/GLThread$EglSurfaceHandle;->eglSurface:Landroid/opengl/EGLSurface;

    invoke-static {p0, v0}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    const/4 p0, 0x0

    .line 381
    iput-object p0, p1, Lcom/oneplus/gl/GLThread$EglSurfaceHandle;->eglSurface:Landroid/opengl/EGLSurface;
...
.method private getCurrentEglSurface()Lcom/oneplus/gl/GLThread$ActiveEglSurfaceHandle;
    ...
    .line 390
    iget-object p0, p0, Lcom/oneplus/gl/GLThread;->m_ActiveEglSurfaceHandles:Ljava/util/LinkedList;

    invoke-virtual {p0}, Ljava/util/LinkedList;->peekLast()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/oneplus/gl/GLThread$ActiveEglSurfaceHandle;
...
.method private makeCurrent(Lcom/oneplus/gl/GLThread$EglSurfaceHandle;)Z
    ...
    const-string v2, "makeCurrent() - No EGL surface for "
    ...
    .line 468
    iget p0, p1, Lcom/oneplus/gl/GLThread$EglSurfaceHandle;->width:I

    iget p1, p1, Lcom/oneplus/gl/GLThread$EglSurfaceHandle;->height:I

    invoke-static {v1, v1, p0, p1}, Landroid/opengl/GLES20;->glViewport(IIII)V
...
.method private restoreEglSurface(Lcom/oneplus/gl/GLThread$ActiveEglSurfaceHandle;I)V
    ...
    const-string v0, "restoreEglSurface() - Fail to restore current EGL surface to "
...
.method private swapBuffers(Lcom/oneplus/gl/GLThread$EglSurfaceHandle;J)Z
    ...
    const-string p1, "swapBuffers() - No EGL surface to swap"
...
.method public final createEglContext(I)Z
    ...
    const-string p1, "createEglContext() - Fail to initialize EGL"
    ...
    .line 231
    :cond_4
    iget-object p0, p0, Lcom/oneplus/gl/GLThread;->m_EglContext:Landroid/opengl/EGLContext;
...
.method public final createEglSurface(Landroid/view/Surface;II)Lcom/oneplus/base/Handle;
    ...
    const-string p1, "createEglSurface() - No EGL context"
    ...
    .line 279
    :cond_2
    iget-object p0, p0, Lcom/oneplus/gl/GLThread;->m_EglSurfaceHandles:Ljava/util/LinkedList;
    ...
    const-string v0, "createEglSurface() - Invalid size : "
...
.method public getEglSurfaceSize(Lcom/oneplus/base/Handle;)Landroid/util/Size;
    ...
    .line 422
    instance-of p0, p1, Lcom/oneplus/gl/GLThread$EglSurfaceHandle;
...
.method public getEglSurfaceSize(Lcom/oneplus/base/Handle;Lcom/oneplus/util/MutableSize;)Z
    ...
    invoke-virtual {p2, p0, p1}, Lcom/oneplus/util/MutableSize;->set(II)V
...
.method public isCurrentEglSurface(Lcom/oneplus/base/Handle;)Z
    ...
    .line 439
    iget-object p0, p0, Lcom/oneplus/gl/GLThread$ActiveEglSurfaceHandle;->surfaceHandle:Lcom/oneplus/gl/GLThread$EglSurfaceHandle;
...
.method public final setCurrentEglSurface(Lcom/oneplus/base/Handle;I)Lcom/oneplus/base/Handle;
    ...
    const-string p1, "setCurrentEglSurface() - No EGL surface handle"
    ...
    const-string p1, "setCurrentEglSurface() - Invalid surface handle"
...
.method public swapBuffers(Lcom/oneplus/base/Handle;J)Z
    ...
    const-string p1, "swapBuffers() - No EGL surface"
    ...
    const-string p1, "swapBuffers() - Not current EGL surface"
