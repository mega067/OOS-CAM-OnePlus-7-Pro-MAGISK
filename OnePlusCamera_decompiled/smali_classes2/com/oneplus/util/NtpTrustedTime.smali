...
.method private constructor <init>()V
    ...
    .line 65
    iget-object p0, p0, Lcom/oneplus/util/NtpTrustedTime;->networkHandler:Lcom/oneplus/base/HandlerThread;
...
.method private final forceRefreshInternal(Z)V
    ...
    .line 136
    sget-object p0, Lcom/oneplus/util/NtpTrustedTime;->TAG:Ljava/lang/String;

    const-string p1, "forceRefreshInternal() - Connectivity manager is empty"
    ...
    const-string p1, "forceRefreshInternal() - Cannot get time from all servers"
    ...
    const-string p1, "forceRefreshInternal() - No network connected"
...
.method private final getTimeFromServer(Lcom/oneplus/util/NtpTrustedTime$ServerType;Z)Z
    ...
    iget-wide v12, v0, Lcom/oneplus/util/NtpTrustedTime;->cachedNtpTime:J
    ...
    iget-wide v12, v0, Lcom/oneplus/util/NtpTrustedTime;->cachedNtpElapsedRealtime:J
    ...
    iget-wide v12, v0, Lcom/oneplus/util/NtpTrustedTime;->cachedNtpCertainty:J
...
.method public final isCacheReady()Z
    ...
    .line 210
    iget-boolean p0, p0, Lcom/oneplus/util/NtpTrustedTime;->isCacheReady:Z
...
.method public final refresh(Z)Z
    ...
    check-cast p0, Lcom/oneplus/base/HandlerObject;

    invoke-static {p1}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object p1

    invoke-virtual {v0, p0, p1}, Lcom/oneplus/base/UniqueCallbackScheduler;->schedule(Lcom/oneplus/base/HandlerObject;Ljava/lang/Object;)Z
