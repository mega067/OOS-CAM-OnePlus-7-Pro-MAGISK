...
.method private isCOUIEnable(Landroid/content/Context;)Z
    ...
    .line 179
    :cond_2
    iget-object p0, p0, Lcom/oneplus/common/OPThemeOverlay;->mMetaCaches:Ljava/util/HashMap;
    ...
    const-string p1, "OPThemeOverlay"
...
.method private isRejectTheme(Landroid/content/Context;)Z
    ...
    const-string p0, "getThemeChangedFlags"
    ...
    invoke-static {v8, v1}, Landroid/util/Base64;->decode([BI)[B
    ...
    invoke-virtual {v6, p0, v7}, Ljava/lang/Class;->getMethod(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
...
.method public clearThemeOverlays()V
    ...
    .line 78
    iget-object p0, p0, Lcom/oneplus/common/OPThemeOverlay;->themeOverlays:Landroid/util/SparseIntArray;
...
.method public getCOUITheme(Landroid/content/res/Configuration;)J
    ...
    const-string p0, "getMaterialColor"
    ...
    const-string v6, ".inner.content.res.ConfigurationWrapper"
    ...
    :catch_0
    :try_start_1
    const-string v5, "com.oplus.inner.content.res.ConfigurationWrapper"
    ...
    const-string v0, "getCOUITheme cls ex: "
