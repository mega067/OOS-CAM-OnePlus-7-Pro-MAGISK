...
.method private constructor <init>(Lcom/oneplus/camera/CameraApp;Landroid/content/pm/ApplicationInfo;Landroid/content/Context;Lorg/json/JSONObject;)V
    ...
    .line 160
    new-instance v0, Lcom/oneplus/camera/plugin/PluginPackage$pluginContext$2;

    invoke-direct {v0, p0, p1, p3}, Lcom/oneplus/camera/plugin/PluginPackage$pluginContext$2;-><init>(Lcom/oneplus/camera/plugin/PluginPackage;Lcom/oneplus/camera/CameraApp;Landroid/content/Context;)V
    ...
    const-string p1, "MinimumCameraSDK"
    ...
    const-string v0, "TargetCameraSDK"

    .line 193
    invoke-virtual {p4, v0, p3}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I
    ...
    const-string p3, "No plug-in defined in "
    ...
    const-string p1, "No minimum or target Camera SDK defined in "
