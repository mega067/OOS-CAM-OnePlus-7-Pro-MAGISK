...
.method public constructor <init>(Lcom/oneplus/camera/OnePlusCamera;Lcom/oneplus/camera/next/hardware/HdrCamcorder;)V
    ...
    new-instance v3, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$updateSelectionOperation$1;

    move-object v5, p0

    check-cast v5, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;

    invoke-direct {v3, v5}, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$updateSelectionOperation$1;-><init>(Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;)V

    check-cast v3, Lkotlin/jvm/functions/Function0;

    invoke-direct {v0, v1, v3}, Lcom/oneplus/threading/UniqueDispatcherOperation;-><init>(Lcom/oneplus/threading/DispatcherObject;Lkotlin/jvm/functions/Function0;)V

    iput-object v0, p0, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;->updateSelectionOperation:Lcom/oneplus/threading/UniqueDispatcherOperation;

    .line 31
    new-instance v1, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$captureStateChangedCB$1;

    invoke-direct {v1, p0}, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$captureStateChangedCB$1;-><init>(Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;)V

    check-cast v1, Lcom/oneplus/base/PropertyChangedCallback;

    iput-object v1, p0, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;->captureStateChangedCB:Lcom/oneplus/base/PropertyChangedCallback;

    .line 34
    new-instance v3, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$enabledCallback$1;

    invoke-direct {v3, p0}, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$enabledCallback$1;-><init>(Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;)V

    check-cast v3, Lcom/oneplus/base/PropertyChangedCallback;

    iput-object v3, p0, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;->enabledCallback:Lcom/oneplus/base/PropertyChangedCallback;

    .line 37
    new-instance v6, Lcom/oneplus/threading/UniqueDispatcherOperation;

    move-object v7, p1

    check-cast v7, Lcom/oneplus/threading/DispatcherObject;

    new-instance v8, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$updateEnablingStateOperation$1;

    invoke-direct {v8, v5}, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$updateEnablingStateOperation$1;-><init>(Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;)V

    check-cast v8, Lkotlin/jvm/functions/Function0;

    invoke-direct {v6, v7, v8}, Lcom/oneplus/threading/UniqueDispatcherOperation;-><init>(Lcom/oneplus/threading/DispatcherObject;Lkotlin/jvm/functions/Function0;)V

    iput-object v6, p0, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;->updateEnablingStateOperation:Lcom/oneplus/threading/UniqueDispatcherOperation;
    ...
    invoke-virtual {v5}, Lcom/oneplus/camera/next/hardware/Camcorder$Companion;->getPROP_IS_CAMCORDER_ENABLED()Lcom/oneplus/base/PropertyKey;

    move-result-object v5

    invoke-interface {p2, v5, v3}, Lcom/oneplus/camera/next/hardware/HdrCamcorder;->addCallback(Lcom/oneplus/base/PropertyKey;Lcom/oneplus/base/PropertyChangedCallback;)V
    ...
    .line 103
    invoke-static {v6, v7, v8, p2, v4}, Lcom/oneplus/threading/UniqueDispatcherOperation;->schedule$default(Lcom/oneplus/threading/UniqueDispatcherOperation;JILjava/lang/Object;)Z

    .line 106
    new-instance v1, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$SubItem;

    invoke-direct {v1, p0, p2}, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$SubItem;-><init>(Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;Z)V

    check-cast v1, Lcom/oneplus/camera/ui/actionpanel/ActionItem;

    invoke-virtual {p0, v1}, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;->addItem(Lcom/oneplus/camera/ui/actionpanel/ActionItem;)V
    ...
    invoke-direct {v1, p0, v3}, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem$SubItem;-><init>(Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;Z)V
    ...
    invoke-virtual {v1}, Lcom/oneplus/camera/ui/actionpanel/ActionItem$Companion;->getPROP_DISPLAY_NAME()Lcom/oneplus/base/PropertyKey;
    ...
    invoke-virtual {p0, v1, p1}, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;->setReadOnly(Lcom/oneplus/base/PropertyKey;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, v1}, Lcom/oneplus/camera/ui/actionpanel/VideoHdrActionItem;->setReadOnly(Lcom/oneplus/base/PropertyKey;Ljava/lang/Object;)Z

    .line 112
    invoke-static {v0, v7, v8, p2, v4}, Lcom/oneplus/threading/UniqueDispatcherOperation;->schedule$default(Lcom/oneplus/threading/UniqueDispatcherOperation;JILjava/lang/Object;)Z
